...
const MovieDetails = () => {
  ...
  return show ? (
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
      ...
      {/* Main Section of a Movie Details */}
      <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
        ...
        <div className='relative flex flex-col gap-3'>
          ...
          <p className='text-gray-400 mt-2 text-sm leading-tight'>{show.movie.overview}</p>

          <p>
            {timeFormat(show.movie.runtime)} - {show.movie.genres.map(genre => genre.name).slice(0,2).join(' | ')} - {show.movie.release_date.split("-")[0]}
          </p>
