...
const AddShows = () => {
  ...
  return nowPlayingMovies.length > 0 ? (
    <div>
      ...
      <button className=' text-lg bg-primary text-white px-8 py-2 mt-6 rounded hover:bg-primary/90 transition-all cursor-pointer'>Add Show</button>
    </div>
  ) : <Loading />
}
